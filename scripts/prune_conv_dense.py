...
# パラメータ利用, 全結合パラメータの凍結
new_net = parameter_use('./result/CIFAR10_conv_prune.pkl')
...
for count in range(1, inv_prune_ratio):
    ...
    for epoch in range(f_num_epochs):
        ...
        result_save('./result/conv_dense_prune_result.csv', data_dict, input_data)

# パラメータの保存
parameter_save('./result/CIFAR10_conv_dense_prune.pkl', new_net)
